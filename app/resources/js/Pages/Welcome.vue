                ...
                <main class="mt-6">
                    <div class="w-full h-full">
                        <div id="docs-card"
                            ...
                            <div class="w-full">
                                <h1 class="text-center text-2xl"> ACLC QR Code-Based Attendance Tracking System </h1>
                                <div class="px-10 py-10">
                                    <p class="indent-8 leading-loose text-lg">A QR Code-Based Attendance Tracking System is a digital solution
                                        designed to
