                            ...
                            <template #header>
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <div class="flex space-x-2 items-center">
                                        ...
                                        <div class="">
                                            <!-- Tiwasa mag buhat ka logic na ma filter kada section -->
                                            <Select v-model="section" :options="sectionOptions" optionLabel="section" placeholder="Select a Section" class="w-full md:w-56" />
                                        </div>
                                    </div>
...
function getSections() {
    sectionOptions.value = page.props.auth.user.sections

    console.log(sectionOptions.value)
}
